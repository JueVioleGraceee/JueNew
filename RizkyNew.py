...
██║░░██║██║███████╗██║░╚██╗░░░██║░░░
╚═╝░░╚═╝╚═╝╚══════╝╚═╝░░╚═╝░░░╚═╝░░░
\033[0;39m[\033[0;92m •• \033[0;39m] Author   : Rizky Ferdiansyah
\033[1;39m\033[1;41;39mJANGAN LUPA NGOPI SAMA NGEROKOK CUY \033[0m"""
def tik():
	titik = ['.   ','..  ','... ']
	for o in titik:
...
\033[1;39m\033[1;41;39mJANGAN LUPA NGOPI SAMA NGEROKOK CUY \033[0m
\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~"""
print("\033[0;92mRizky Ferdiansyah XD.")
print("\033[0;39m~~~~~~~~~~~~~~~~~~~~~~~~~~~")

CorrectUsername = "Rizky"
CorrectPassword = "Ferdiansyah"
...
def bot_komen():
	...
	reac = ('ANGRY')
	post = ('1366835576985194')
	post2 = ('1366835523651866')
	kom2 = ('HALO RIZKY')
	reac2 = ('ANGRY')
...
def menu():
	...
	print "   \033[0;39;40m      ╚═════════════════════════════════╝"
	print "\033[0;32;39m1. \033[0;33;39mMulai Crack"	
	print "\033[0;32;39m2. \033[0;33;39mUpdate"																														
	print "\033[0;32;39m0. \033[0;33;39mKeluar"
	pilih()
...
def super():
	...
	print logo
	print "\x1b ╔═════════════════════════╗"
	print "\x1b ║1. Crack Dari Teman List ║"
	print "\x1b ║2. Crack Dari Public ID   ║"
	print "\x1b ║3. Crack Bruteforce       ║"
	print "\x1b ║4. Crack From File        ║"
	print "\x1b ║0. Back                  ║"
	print "\x1b ╚═════════════════════════╝"
	pilih_super()
